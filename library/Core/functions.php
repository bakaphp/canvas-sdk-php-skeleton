...
if (!function_exists('Gewaer\Core\appPath')) {
    /**
...
if (!function_exists('Gewaer\Core\envValue')) {
    /**
...
if (!function_exists('Gewaer\Core\appUrl')) {
    /**
...
if (!function_exists('Gewaer\Core\paymentGatewayIsActive')) {
    /**
...
if (!function_exists('Gewaer\Core\isJson')) {
    /**
...
if (!function_exists('Gewaer\Core\isSwooleServer')) {
    /**
